...
function help(appname) {
  return {
    heading: 'Usage: ' + cyan(appname + ' <command> [options]')
      + '\n\nCommand: Generators or tasks to run'
      + '\n\nExamples:'
      ...
      + gray('\n\n  Verb attempts to automatically determine if "foo" is a task or generator.'
      + '\n  If there is a conflict, you can force verb to run generator "foo"'
      + '\n  by specifying a task on the generator. Example: `verb foo:default`')
      + '\n\nOptions:',
